...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>Welcome to GOLDRAUSCH</h1>
                    <p>Here you can buy a German jewellery! Order now! </p>
                </div>
            </div>
        </div>
        <div class="item">
        ...
        <div class="item">
            <img class="second-slide home-image"
                        src="<c:url value="/resources/images/background3.jpeg"/> "
                 alt="Third slide">
            <div class="container">
                <div class="carousel-caption">
                    <h1>German Jewellery</h1>
                    <p>qwertyuiop0-asdfghjkl;'zxcvbnm,./</p>
